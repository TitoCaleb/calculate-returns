  ...
  const portfolios = [
    {
      ...
      id: "515a2770-98b8-11ec-b5c4-1ddf1d689632",
      balances: [
        {
          amount: 70.9,
          currency: "USD",
      ...
      creationDate: 1646067794791,
      currentDate: 1757394000000,
      funds: [
        {
          id: "cash",
          balance: {
        ...
        },
        {
          ...
          costBasis: 39.48,
          creationDate: 1662759000000,
          currency: "USD",
          returns: {
            realized: 1.47777596,
            unRealized: 8.98222404,
          },
          series: "SERIES_B",
          sharePrice: 14.63816309,
        },
        {
          id: "globalCashPEN",
          availableBalance: {
          ...
          costBasis: 3000.87,
          creationDate: 1740322800000,
          currency: "PEN",
          returns: {
            realized: -28.94876968,
            unRealized: -2118.58123032,
          },
          series: "SERIES_O",
          sharePrice: 11.50274917,
        },
      ],
      lastAvailableBalanceUpdate: 1757562741817,
      lastBalanceUpdate: 1757562741662,
      lastUpdate: 1675307259907,
